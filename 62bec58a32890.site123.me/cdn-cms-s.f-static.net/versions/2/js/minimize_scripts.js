...
function TopSectionInitialize() {
    $(document).on('s123.page.ready', function(event) {
        $.each($('#websitePopupHomeVideo, .promoVideoPopup .iconsCircle, #home_buttonText, #home_buttonText_1, #topAction_buttonText_1, #topAction_buttonText_2, #promoRedirectButton1, #promoRedirectButton2, .s123-widget [data-video-popup="true"]'), function(index, el) {
...
function ActiveLazyImageLoad() {
    ...
    function fixSafariPromoImages() {
        if (IsWizard() && /^((?!chrome|android).)*safari/i.test(navigator.userAgent)) {
            $('.s123-module[data-module-type-num="1000"] .promoImageInline .lazyload:not(.loaded), .s123-module[data-module-type-num="159"] .s123-widget[data-type="imageWidget"] .lazyload:not(.loaded)').each(function(index, img) {
                LazyLoad.load(img, {
...
function s123VideoHandler($obj) {
    ...
    (function() {
        ...
        function onPlayerReady(event) {
            if (isMobile.iOS()) event.target.mute();
